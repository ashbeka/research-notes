...
## 2. Objectives
(i) Jointly segment damage levels (ordinal) and land-use; (ii) model temporal change via first/second-order subspace deltas; (iii) deliver decision-ready heatmaps with an MCDA layer for triage and resource allocation.
